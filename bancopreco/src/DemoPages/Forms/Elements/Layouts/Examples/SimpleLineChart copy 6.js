...
const getPlayerMax_on = (cod) =>
  dataApi.reduce((a, c) => (+a[cod] < +c[cod] ? c : a));
const maxApi = getPlayerMax_on("max");
const getPlayerMin_on = (cod) =>
  dataApi.reduce((a, c) => (+a[cod] > +c[cod] ? c : a));
const minApi = getPlayerMin_on("min");

const RetornoapiArupamento = (props) => {
  console.log(props.dadosApi)
}
            ...
            <div className="chartsPrincipal">
              ...
              <Row>
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-chart-content">
                      <div className="widget-numbers">R$ ?</div>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-chart-content">
                      <div className="widget-numbers">R$ {minApi.min},00</div>
                      <div className="widget-subheading">
                        <h1>Preço Mínimo </h1>
                      </div>
                    </div>
                ...
                <Col md="4">
                  <div className="card mb-3 widget-chart">
                    <div className="widget-chart-content">
                      <div className="widget-numbers"> R$ {maxApi.max},00</div>
                      <div className="widget-subheading">
                        <h1>Preço Máximo</h1>
                      </div>
                    </div>
                    ...
                    <CardBody className="pt-2">
                      <Row className="mt-3">
                        <Col md="6">
                          ...
                          <LineChart width={650} height={300} data={dataApi}>
                            <Line
                              type="monotone"
                              dataKey="mean"
                              stroke="#008080	"
