 ...
 */ function D(t) {
    ...
    if (N.logLevel <= c.DEBUG) {
        var r = e.map(C);
        N.debug.apply(N, E([ "Firestore (8.6.7): " + t ], r));
    }
}
...
function k(t) {
    ...
    if (N.logLevel <= c.ERROR) {
        var r = e.map(C);
        N.error.apply(N, E([ "Firestore (8.6.7): " + t ], r));
    }
}
...
function R(t) {
    ...
    if (N.logLevel <= c.WARN) {
        var r = e.map(C);
        N.warn.apply(N, E([ "Firestore (8.6.7): " + t ], r));
    }
}
 ...
 */ function L(t) {
    ...
    // exception is swallowed.
        var e = "FIRESTORE (8.6.7) INTERNAL ASSERTION FAILED: " + t;
 ...
 */
    ...
    t.prototype.Fi = function(t, e) {
        if (t["X-Goog-Api-Client"] = "gl-js/ fire/8.6.7", 
...
//# sourceMappingURL=prebuilt-3a676112-7f3284f9.js.map
